  ...
  const users = [
    {
      ...
      intro: 'Emerging users, seeking personalized solutions and flexible financial options.',
      color:'royalblue',
      tag: 'Satisfied'
    },
    {
      ...
      color:'lightseagreen',
      intro: 'Loyal clients, who value consistent service quality and transparent communication.',
      tag: 'Underserved'
    },
    {
      ...
      color:'orange',
      intro: 'New customers, exploring digital platforms for faster and smarter transactions.',
      tag: 'Underbanked'
    },
    {
      ...
      color:'pink',
      intro: 'Potential buyers, comparing market options and looking for trusted partnerships.',
      tag: 'Underwear'
    },
    {
      ...
      intro:'High-value investors, focused on long-term growth and sustainable returns.',
      color:'black',
      tag:'Average'
    }
  ]
